...
That's the claim. Building things has got cheap. Knowing what's wrong with the thing you built hasn't.
...
Engineers get code review, which is the same mechanism pointed at a different object. Review teaches you taste in code, what's clean, what'll bite you, what's clever in the bad way. It teaches you much less about whether the thing the code makes is any good, because that's not what's on the wall.
...
There's a third one that I think about more. The app's home page promises never an exact pin. When I built the spots feature, the spec had them as precise, pinnable places, and I changed it to warm-and-cold guidance for that reason alone. Two people later argued the map weakened the gate and asked me to blur it. I went the other way and drew every spot at its exact point, because the promise was about the words and the photo, which you only get by standing there, rather than about the place. Two people I respected were arguing in good faith and I held the line anyway.
...
I had to send the first draft of nearly every post I've written this month back for sounding like the tool that drafted it. The reflex that catches that is the same one that catches the wrong event name. Without it the agent will keep handing you something that isn't yours, and it will be fine, and nobody will love it.
